...
public class NoteProvider extends ContentProvider {
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(NoteContract.CONTENT_AUTHORITY, NoteContract.PATH_PETS, PETS);
        ...
        sUriMatcher.addURI(NoteContract.CONTENT_AUTHORITY, NoteContract.PATH_PETS + "/#", PET_ID);
    }
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(NoteContract.NoteEntry.COLUMN_NOTE_CONTENT);
        if (name == null) {
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link NoteEntry#COLUMN_PET_NAME} key is present,
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                ...
                rowsDeleted = database.delete(NoteContract.NoteEntry.TABLE_NAME, selection,
                        selectionArgs);
                break;
            case PET_ID:
